    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-4 gap-8 mb-12">
            <div class="md:col-span-2">
                <a href="#" class="font-serif text-3xl font-bold">Minimal<span class="text-amber-500">.</span></a>
        ...
        <div class="border-t border-stone-800 pt-8 text-center text-stone-500 text-sm">
            <p>&copy; <?php echo date('Y'); ?> Minimal Blog. All rights reserved. Crafted with ♥ for mindful readers.</p>
        </div>
    </div>
</footer>
...
<script>
    ...
    if (togglePasswordBtn && passwordInput) {
        togglePasswordBtn.addEventListener('click', function() {
            ...
            // Toggle the eye icon
            // We can swap the innerHTML or just toggle a class if we had one.
            // For now, let's just swap the icon paths.
            const eyeIcon = `
            ...
            this.querySelector('svg').innerHTML = type === 'password' ? eyeIcon : eyeOffIcon;
        });
    }
</script>
</body>
